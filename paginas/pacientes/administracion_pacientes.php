...
<head>
    ...
    <link rel="stylesheet" href="administracion_pacientes.css">
...
<body>
  ...
  <header>
    ...
    <div class="patient-table">
        <h2>Pacientes Registrados</h2><br>
        <table>
            <thead>
                <tr>
                    <th>ID</th>
            ...
            <tbody>
                ...
                $result = $db->query("SELECT id, nombre, apellido, telefono FROM pacientes");
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='vista_paciente.php?id={$row['id']}' class='action-view' title='Ver'><i class='fas fa-eye'></i></a>
                                <a href='actualizar_pacientes.php?id={$row['id']}' class='action-edit' title='Modificar'><i class='fas fa-edit'></i></a>
                                <a href='#' class='action-delete' title='Eliminar' onclick='confirmDelete({$row['id']})'><i class='fas fa-trash'></i></a>
                              </td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='5'>No hay pacientes en la base de datos.</td></tr>";
                }
