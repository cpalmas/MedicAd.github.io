...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: administracion_pacientes.php?msg=success");
    } else {
        // Redirigir a la página de la tabla con un mensaje de error
        header("Location: administracion_pacientes.php?msg=error");
    }
    ...
    header("Location: administracion_pacientes.php?msg=invalid");
}
?>
