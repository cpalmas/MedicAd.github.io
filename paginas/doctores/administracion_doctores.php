...
<head>
    ...
    <link rel="stylesheet" href="administracion_doctores.css">
    ...
    <div class="doctor-table">
        ...
        <table>
            ...
            <tbody>
                ...
                $result = $db->query("SELECT id_doc, nombre, apellido, especialidad, numero_licencia FROM doctores");
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td>
                                <a href='ver_doctor.php?id={$row['id_doc']}' class='action-view' title='Ver'><i class='fas fa-eye'></i></a>
                                <a href='actualizar_doctor.php?id={$row['id_doc']}' class='action-edit' title='Modificar'><i class='fas fa-edit'></i></a>
                                <a href='#' class='action-delete' title='Eliminar' onclick='confirmDelete({$row['id_doc']})'><i class='fas fa-trash'></i></a>
                              </td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='5'>No hay doctores en la base de datos.</td></tr>";
                }
