...
<head>
    <meta charset="UTF-8">
    <title>Alta de Chequeo Médico</title>
...
<div class="container">
    <h1>Registrar Nuevo Chequeo Médico</h1>
    <form action="alta.php" method="POST">
        ...
        <label for="fecha_chequeo">Fecha del Chequeo:</label>
        <input type="datetime-local" id="fecha_chequeo" name="fecha_chequeo">
        ...
        <input type="text" id="acido_urico" name="acido_urico">
        ...
        <button class="la_button" type="submit">Registrar Chequeo Médico</button>
    </form>
</div>
<footer class="footer">
